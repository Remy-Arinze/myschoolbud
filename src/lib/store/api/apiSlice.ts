...
export const apiSlice = createApi({
  ...
  tagTypes: ['Student', 'School', 'User', 'Timetable', 'Event', 'Session', 'ClassLevel', 'ClassArm', 'Subject', 'Room', 'Class', 'ClassResource', 'StudentResource', 'Permission', 'RoleTemplate', 'Curriculum', 'Grade', 'Grades', 'Transfer', 'Subscription', 'SubscriptionPlan', 'TeacherSubject', 'Faculty', 'Department', 'SchoolErrors', 'Error', 'ErrorStats', 'TeacherWorkload', 'Assessments', 'Submissions', 'AiHistory', 'Attendance', 'SchemeOfWork', 'AgoraCurriculum', 'AgoraCurriculumSource', 'AgoraSubject', 'Campaigns', 'LoisSystemConfig', 'LoisSkills', 'LoisInsights', 'Notification', 'SchoolSettings', 'BackupStatus'],
  endpoints: (builder) => ({
