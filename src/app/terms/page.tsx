            ...
            <main className="max-w-4xl mx-auto px-6 pt-32 pb-24">
                <FadeInUp duration={0.6}>
                    ...
                    <p className="text-[var(--dark-text-secondary)] text-lg mb-12 leading-relaxed">
                        Last updated: March 5, 2026. Please read these terms carefully before using the School Bud platform.
                    </p>
                    ...
                    <div className="space-y-12 text-[var(--dark-text-secondary)] leading-relaxed text-sm md:text-base">
                        <section className="space-y-4">
                            ...
                            <p>
                                By accessing or using School Bud ("the Platform"), you agree to be bound by these Terms of Service. School Bud is a comprehensive school management and academic identity ecosystem. Our services are available only to legal entities (schools) and individuals (parents, students, teachers) who can form legally binding contracts under applicable law.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                School Bud provides a unified management system designed to digitize legacy records and verify student identities. At its core is the "Chain-of-Trust"—a cryptographically secured registry where:
                            </p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                School Bud introduces a paradigm shift in data ownership. While schools input and verify data, the verified academic profile (the "Academic Identity") belongs to the student. This identity is "borderless"—it moves seamlessly between institutions within the School Bud ecosystem, eliminating the need for manual transcript requests when transferring schools.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                Users of School Bud AI and our grading systems agree to use these tools to augment, not replace, human pedagogical judgment. Schools are responsible for the final validation of any AI-generated content or grades. Any attempt to upload fraudulent records or bypass the verification protocols will result in immediate termination of the institutional license.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                Access to the Platform is tiered. Paid plans grant access to School Bud AI via a token-based system. Tokens are consumed based on the complexity of the AI task (e.g., grading an essay vs. generating a quiz). Unused tokens expire at the end of the billing cycle unless specified otherwise in your plan.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4 border-t border-[var(--dark-border)] pt-12">
                            ...
                            <div className="bg-[var(--dark-surface)] p-6 rounded-2xl border border-[var(--dark-border)] transition-colors duration-300">
                                <p className="font-semibold text-[var(--dark-text-primary)]">School Bud Legal & Operations</p>
